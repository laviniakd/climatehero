...
/*AddUserCreated successfully added user
...
type AddUserCreated struct {
	...
	/*
	  In: Body
	*/
	Payload *models.Name `json:"body,omitempty"`
}
...
func (o *AddUserCreated) WithPayload(payload *models.Name) *AddUserCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add user created response
func (o *AddUserCreated) SetPayload(payload *models.Name) {
	o.Payload = payload
}
